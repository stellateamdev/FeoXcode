...
public class Countries {
    ...
    public class func countryFromPhoneExtension(phoneExtension: String) -> Country {
        ...
        for country in countries {
            for name in country {
            if name.isMain && phoneExtension == name.phoneExtension {
                return name
            }
            }
        }
    ...
    public class func phoneExtensionFromCountryCode(countryCode:String) -> String {
        for country in countries {
            for name in country {
                if countryCode == name.countryCode {
                    return name.phoneExtension
                }
            }
        }
        return Country.emptyCountry.name
    }
